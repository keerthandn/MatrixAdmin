        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
           ...
           <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-attributes/'.$productDetails->id) }}" name="add_attributes" id="add_attributes"> 
              {{ csrf_field() }}
              ...
              <tbody>
               ...
               <tr class="gradeX">
                 ...
                 <td class="center">
                 		...
                 		<a id="delProduct" onclick="return confirm('Are you sure you want to delete product?')" href="{{ url('/admin/delete-product/'.$attribute->id)}}" class="btn btn-danger btn-mini">Delete</a>
                 </td>
            </div>
                </tr>
                @endforeach
